...
//Conexion a MongoDB
mongoose.connect('mongodb://127.0.0.1:27017/centro_odontologico')
...
app.post('/visitas', async (req, res) => {
    try {
        ...
        res.status(500).json({ error: 'Hubo un error al guardar la visita en el servidor.' });
    }
});
...
app.get('/visitas', async (req, res) => {
    try {
        ...
        res.status(500).json({ error: 'Hubo un error al obtener las visitas del servidor.' });
    }
});
